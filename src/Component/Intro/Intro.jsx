    ...
    <div className="intro">
        <div className="i-left">
            <div className="i-name">
                <span style={{color: darkMode? 'white' : '', transition: '1s ease all',}} >Hy! I Am</span>
                <span>Ashutosh Tiwari</span>
                <p>Frontend Developer with high level of 
                experience in web designing & development, 
                Producing the qualty work.</p>
            </div>
        ...
        <div className="i-right">
            ...
            <div 
                className="blur" 
                style={{backgound:"rgb(238 210 255)"}}
             ></div>
             <div className="blur"
